/**
 * File page-microsite1.js
 *
 * adds microsite 1 tempalte specific js
 *
 *
 */
        ...
        if (stickySidebar.length > 0) { 
          ...
          if (sidebarTop < scrollTop && stickyHeight < contentHeight) {
            ...
            var sidebarBottom = stickySidebar.offset().top + stickyHeight,
                stickyStop = $('#sidebar .sticky-nav').offset().top + $('#sidebar .sticky-nav').height() + footerHeight;
...
(function($) {
      var stickySidebar = $('#pacc-sidebar .sticky-nav');
      ...
      $(window).scroll(function () {
        if (stickySidebar.length > 0) { 
          ...
          if (sidebarTop < scrollTop && stickyHeight < contentHeight) {
            ...
            // stop the sticky sidebar at the footer to avoid overlapping
            var sidebarBottom = stickySidebar.offset().top + stickyHeight,
                stickyStop = $('#pacc-sidebar .sticky-nav').offset().top + $('#pacc-sidebar .sticky-nav').height() + footerHeight;
            if (stickyStop < sidebarBottom ) {
              var stopPosition = $('#pacc-sidebar .sticky-nav').height() - stickyHeight ;
              stickySidebar.css('top', stopPosition).removeClass('sticky-active');
            }
          }
          else {
    ...
    /*********************
     * 
     *  Change classes on sidebar based on width
     * 
     */
  (function($) {
    var sidebar = $('#sidebar');
    ...
    if (window.innerWidth > 1440) {
      sidebar.addClass('large-2').removeClass('large-3');
    } else {
      sidebar.addClass('large-3').removeClass('large-2');
    }
